"""
Django settings for rugby_backend project.
...
SECRET_KEY = 'django-insecure-#hcfi@kn-u(4&x&zp9+vvkkm!v*s41#0go@$0g5@b%l!qj(#$9'
...
ROOT_URLCONF = 'rugby_backend.urls'
...
WSGI_APPLICATION = 'rugby_backend.wsgi.application'
